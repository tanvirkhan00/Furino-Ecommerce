            ...
            <section className="product mt-[50px] px-[50px] mx-auto">
                <div className="container flex flex-col gap-[30px]">
                    ...
                    <div className="flex flex-wrap gap-[20px]">
                        {abc?.map((item) => (
                            <div className="basis-[24%] relative bg-slate-200 rounded-md">
                                <Link to={`/Shop/${item.id}`}><img src={item.thumbnail} alt="" className='h-[200px]' /></Link>
                                ...
                                <div className="absolute bg-red-500 text-[12px] rounded-full w-[48px] h-[48px] flex items-center justify-center right-[20px] top-[20px] text-white">
